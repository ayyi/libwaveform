...
void             frame_clock_request_phase           (GdkFrameClockPhase);
void             frame_clock_begin_updating          ();
void             frame_clock_end_updating            ();
void             frame_clock_connect                 (GCallback, gpointer);
void             frame_clock_disconnect              (GCallback, gpointer);

GType            gdk_frame_clock_get_type            (void) G_GNUC_CONST;

gint64           gdk_frame_clock_get_frame_time      (GdkFrameClock*);

void             gdk_frame_clock_request_phase       (GdkFrameClock*, GdkFrameClockPhase);
...
gint64           gdk_frame_clock_get_history_start   (GdkFrameClock*);
GdkFrameTimings* gdk_frame_clock_get_timings         (GdkFrameClock*, gint64 frame_counter);

GdkFrameTimings* gdk_frame_clock_get_current_timings (GdkFrameClock*);

void             gdk_frame_clock_get_refresh_info    (GdkFrameClock*, gint64 base_time, gint64* refresh_interval_return, gint64* presentation_time_return);
