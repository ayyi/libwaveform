...
void main(void)
{
	...
	/*
	sum += texture2D(tex2d, vec2(vTexCoord.x - 4.0*blurSize, vTexCoord.y)) * 0.05;
	sum += texture2D(tex2d, vec2(vTexCoord.x - 3.0*blurSize, vTexCoord.y)) * 0.09;
	sum += texture2D(tex2d, vec2(vTexCoord.x - 2.0*blurSize, vTexCoord.y)) * 0.12;
	sum += texture2D(tex2d, vec2(vTexCoord.x - 1.0*blurSize, vTexCoord.y)) * 0.15;
	sum += texture2D(tex2d, vec2(vTexCoord.x,                vTexCoord.y)) * 0.16;
	sum += texture2D(tex2d, vec2(vTexCoord.x + 1.0*blurSize, vTexCoord.y)) * 0.15;
	sum += texture2D(tex2d, vec2(vTexCoord.x + 2.0*blurSize, vTexCoord.y)) * 0.12;
	sum += texture2D(tex2d, vec2(vTexCoord.x + 3.0*blurSize, vTexCoord.y)) * 0.09;
	sum += texture2D(tex2d, vec2(vTexCoord.x + 4.0*blurSize, vTexCoord.y)) * 0.05;
