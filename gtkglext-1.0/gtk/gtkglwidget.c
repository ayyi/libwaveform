...
static void
gtk_gl_widget_size_allocate (GtkWidget *widget, GtkAllocation *allocation, GLWidgetPrivate *private)
{
                              ...
                              int           render_type)
{
  ...
  if (share_list != NULL && GDK_IS_GL_CONTEXT_IMPL_X11 (share_list))
    {
