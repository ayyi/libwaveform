...
GdkGLConfig *gdk_gl_config_new_for_screen         (GdkScreen*, const int *attrib_list);

#ifndef GDK_MULTIHEAD_SAFE
GdkGLConfig *gdk_gl_config_new_by_mode            (GdkGLConfigMode);
#endif /* GDK_MULTIHEAD_SAFE */

GdkGLConfig *gdk_gl_config_new_by_mode_for_screen (GdkScreen*, GdkGLConfigMode);
GdkScreen   *gdk_gl_config_get_screen             (GdkGLConfig*);
gboolean     gdk_gl_config_get_attrib             (GdkGLConfig*, int attribute, int *value);
GdkColormap *gdk_gl_config_get_colormap           (GdkGLConfig*);
GdkVisual   *gdk_gl_config_get_visual             (GdkGLConfig*);
gint         gdk_gl_config_get_depth              (GdkGLConfig*);
gint         gdk_gl_config_get_layer_plane        (GdkGLConfig*);
gint         gdk_gl_config_get_n_aux_buffers      (GdkGLConfig*);
gint         gdk_gl_config_get_n_sample_buffers   (GdkGLConfig*);
gboolean     gdk_gl_config_is_rgba                (GdkGLConfig*);
gboolean     gdk_gl_config_is_double_buffered     (GdkGLConfig*);
gboolean     gdk_gl_config_has_alpha              (GdkGLConfig*);
gboolean     gdk_gl_config_has_depth_buffer       (GdkGLConfig*);
gboolean     gdk_gl_config_has_stencil_buffer     (GdkGLConfig*);
gboolean     gdk_gl_config_has_accum_buffer       (GdkGLConfig*);
