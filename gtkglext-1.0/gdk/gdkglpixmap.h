 ...
 */
GdkGLPixmap* gdk_gl_pixmap_new              (GdkGLConfig*, GdkPixmap*, const int* attrib_list);
GdkPixmap*   gdk_gl_pixmap_get_pixmap       (GdkGLPixmap*);

/*
 * OpenGL extension to GdkPixmap
 */

GdkGLPixmap* gdk_pixmap_set_gl_capability   (GdkPixmap*, GdkGLConfig*, const int* attrib_list);
void         gdk_pixmap_unset_gl_capability (GdkPixmap*);
gboolean     gdk_pixmap_is_gl_capable       (GdkPixmap*);
GdkGLPixmap* gdk_pixmap_get_gl_pixmap       (GdkPixmap*);

#define      gdk_pixmap_get_gl_drawable(pixmap) \
  GDK_GL_DRAWABLE (gdk_pixmap_get_gl_pixmap (pixmap))

GdkGLConfig* gdk_gl_pixmap_get_gl_config        (GdkGLDrawable*);
gboolean     gdk_gl_pixmap_make_context_current (GdkGLDrawable*, GdkGLContext*);
