...
NGRenderer med_renderer_gl2 = {{MODE_MED, med_renderer_new_gl2, ng_load_block, ng_load_blocks, ng_pre_render0, ng_gl2_render_block, ng_post_render, ng_free_waveform}};
