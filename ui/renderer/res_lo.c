...
NGRenderer lo_renderer_gl2 = {{MODE_LOW, low_new_gl2, ng_gl2_load_block, ng_pre_render0, ng_gl2_render_block, ng_gl2_post_render, ng_gl2_free_waveform}};
...
lo_renderer_init ()
{
	...
	return (Renderer*)&lo_renderer_gl2;
}
